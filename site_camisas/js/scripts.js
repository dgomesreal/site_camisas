...
$(function(){
    ...
    //Verificar local storage e atualizar a variavel parametros_pesquisa
...
{
    $('.refresh-loader').show();3

    var quantidade = parametros_pesquisa.quantidade;
    var preco_unitario = camisetas[parametros_pesquisa.cor][parametros_pesquisa.gola][parametros_pesquisa.estampa].preco_unit;
    var foto = "img/" + camisetas[parametros_pesquisa.cor][parametros_pesquisa.gola][parametros_pesquisa.estampa].preco_unit;
